    ...
    try:
        ...
        if m.chat.type == enums.ChatType.PRIVATE:
            keyboard = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton("💬 Support", url="https://t.me/anime_group_asia")
                    ],[
            ...
            keyboar = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("💁‍♂️ Start me private 💁‍♂️", url="https://t.me/Dk_auto_request_appove_bot?start=start")
                    ]
                ]
            )
            add_group(m.chat.id)
